  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] animate-fade-in">
      <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-slate-800/50 rounded-lg shadow-lg">
        <h1 className="text-2xl font-bold text-center text-slate-800 dark:text-white">Create your Account</h1>
        <p className="text-center text-sm text-slate-500 dark:text-slate-400">Join Nexus Blog to start writing</p>
        ...
        <p className="text-center text-sm text-slate-500 dark:text-slate-400">
          Already have an account? <Link to="/login" className="font-medium text-cyan-500 hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
